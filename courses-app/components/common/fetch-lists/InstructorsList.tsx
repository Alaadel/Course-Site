...
export default function InstructorsList({ instructors, getSelectedInstructor, onAddInstructor }: { instructors: InstructorDataType[], getSelectedInstructor?: (instructor: string) => void, onAddInstructor?: (instructor: string) => void }) {
